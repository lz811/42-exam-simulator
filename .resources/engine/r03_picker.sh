...
case $opt in
    ...
    1)
        ...
        spin_wait
        clear
        bash practice_core.sh rank03 level1
        ;;
    2) 
        mkdir ../../rendu
        clear
        ...
        spin_wait
        clear
        bash practice_core.sh rank03 level2
        ;;
    exit)
        cd ../../../../
        rm -rf rendu
